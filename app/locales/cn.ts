  ...
  Settings: {
    ...
    Access: {
      ...
      CustomProviders: {
        Title: "自定义服务商",
        SubTitle:
          "任何 OpenAI 兼容接口：OpenRouter、Together、Ollama、LM Studio、自建代理…",
        Add: "添加服务商",
        AddTitle: "添加自定义服务商",
        EditTitle: "编辑服务商",
        Name: "名称",
        ...
        EndpointSub: "OpenAI 兼容接口地址，末尾不要加 /v1",
        ApiKey: "API 密钥",
        Enabled: "启用",
        UseProxy: "使用服务端代理",
        UseProxySub: "经由 /api/proxy 转发请求（避免跨域）。纯静态导出时请关闭。",
        Save: "保存",
        Test: "测试",
        FetchModels: "获取模型",
        AddModel: "+ 模型",
        AddModelPrompt: "模型 ID（与服务商提供的一致）：",
        Edit: "编辑",
        Delete: "删除",
        DeleteConfirm: "删除该服务商并停用其模型？",
        ModelsCount: (n: number) => `${n} 个模型`,
        NeedName: "请输入服务商名称",
        NeedEndpoint: "请输入 Base URL",
        DupName: "已存在同名服务商",
        TestOk: (n: number) => `连接正常，可用模型 ${n} 个`,
        TestFail: (msg: string) => `连接失败：${msg}`,
        FetchOk: (n: number) => `已导入 ${n} 个模型，请在聊天模型选择器中选用`,
        FetchEmpty: "服务商未返回模型，可手动添加模型 ID。",
        ModelAdded: (id: string) => `已添加模型 ${id}`,
      },
      Provider: {
        Title: "模型服务商",
        SubTitle: "切换不同的服务商",
