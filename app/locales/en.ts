  ...
  Settings: {
    ...
    Access: {
      ...
      CustomProviders: {
        ...
        SubTitle:
          "Any OpenAI-compatible API: OpenRouter, Together, Ollama, LM Studio, your own proxy…",
        Add: "Add provider",
        AddTitle: "Add custom provider",
        EditTitle: "Edit provider",
        Name: "Name",
        NamePlaceholder: "MyProxy",
        Endpoint: "Base URL",
        EndpointPlaceholder: "https://api.example.com",
        EndpointSub: "OpenAI-compatible base URL, without trailing /v1",
        ApiKey: "API Key",
        Enabled: "Enabled",
        UseProxy: "Use server proxy",
        UseProxySub:
          "Route requests via /api/proxy (avoids CORS). Turn off for static export.",
        Save: "Save",
        Test: "Test",
        FetchModels: "Fetch models",
        AddModel: "+ Model",
        AddModelPrompt: "Model id (as exposed by the provider):",
        Edit: "Edit",
        Delete: "Delete",
        DeleteConfirm: "Delete this provider and disable its models?",
        ModelsCount: (n: number) => `${n} models`,
        NeedName: "Please enter a provider name",
        NeedEndpoint: "Please enter the base URL",
        DupName: "A provider with this name already exists",
        TestOk: (n: number) => `OK — ${n} models available`,
        TestFail: (msg: string) => `Connection failed: ${msg}`,
        FetchOk: (n: number) =>
          `Imported ${n} models — pick one in the chat model selector`,
        FetchEmpty:
          "Provider returned no models. You can add model ids manually.",
        ModelAdded: (id: string) => `Model ${id} added`,
      },
      Provider: {
