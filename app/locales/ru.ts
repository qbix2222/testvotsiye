  ...
  Settings: {
    ...
    Access: {
      ...
      CustomProviders: {
        ...
        SubTitle:
          "Любой OpenAI-совместимый API: OpenRouter, Together, Ollama, LM Studio, свой прокси…",
        Add: "Добавить провайдера",
        AddTitle: "Новый провайдер",
        EditTitle: "Редактировать провайдера",
        Name: "Название",
        NamePlaceholder: "МойПрокси",
        Endpoint: "Base URL",
        EndpointPlaceholder: "https://api.example.com",
        EndpointSub: "Base URL OpenAI-совместимого API, без /v1 на конце",
        ApiKey: "API-ключ",
        Enabled: "Включён",
        UseProxy: "Через серверный прокси",
        UseProxySub:
          "Запросы через /api/proxy (без проблем CORS). Выключите для статического экспорта.",
        Save: "Сохранить",
        Test: "Проверить",
        FetchModels: "Загрузить модели",
        AddModel: "+ Модель",
        AddModelPrompt: "ID модели (как отдаёт провайдер):",
        Edit: "Изменить",
        Delete: "Удалить",
        DeleteConfirm: "Удалить провайдера и отключить его модели?",
        ModelsCount: (n: number) => `Моделей: ${n}`,
        NeedName: "Введите название провайдера",
        NeedEndpoint: "Введите base URL",
        DupName: "Провайдер с таким названием уже есть",
        TestOk: (n: number) => `ОК — доступно моделей: ${n}`,
        TestFail: (msg: string) => `Ошибка подключения: ${msg}`,
        FetchOk: (n: number) =>
          `Импортировано моделей: ${n} — выберите модель в селекторе чата`,
        FetchEmpty: "Провайдер не вернул моделей. Можно добавить ID вручную.",
        ModelAdded: (id: string) => `Модель ${id} добавлена`,
      },
      Provider: {
